...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    profileState.getProfileUser(widget.profileId);
          ...
          children: [
            ...
            IconButton(
              ...
              icon: feedModel.likeList!
                      .any((x) => x.userId == profileState.userId)
                  ? const Icon(
                      Icons.favorite,
  ...
  Widget build(BuildContext context) {
    var profileState = Provider.of<ProfileState>(context, listen: true);
    var feedState = Provider.of<FeedState>(context, listen: false);
    feedState.getDataFromDatabase();

    List<FeedModel>? listFeed;

    String id = widget.profileId ?? profileState.userModel!.userId!;
    ...
    return profileState.isBusy
        ? loader()
        : Scaffold(
            body: profileState.profileUserModel == null
                ? loader()
                : CustomScrollView(
                    slivers: [
                      SliverAppBar(
                        ...
                        delegate: SliverChildListDelegate(
                          [
                            ...
                            Padding(
                              ...
                              child: customText(
                                  profileState.profileUserModel!.displayName,
                                  style: titleStyle),
                            ),
                            Padding(
                              padding:
                              ...
                              child: customText(
                                  profileState.profileUserModel!.username,
                            ...
                            Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    customText(
                                        profileState.profileUserModel!.location,
                            ...
                            Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    customText(
                                        Utility.getdob(
                                            profileState.profileUserModel!.dob),
                                        style: const TextStyle(
                                            color: Colors.black54)),
                                  ],
                                )),
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  customText(
                                      profileState.profileUserModel!
                                                  .followers !=
                                              null
                                          ? '${profileState.profileUserModel!.followers!.length}'
                                          : '0',
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 17)),
                                  ...
                                  customText(
                                      profileState.profileUserModel!
                                                  .followers !=
                                              null
                                          ? '${profileState.profileUserModel!.following!.length}'
                                          : '0',
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 17)),
